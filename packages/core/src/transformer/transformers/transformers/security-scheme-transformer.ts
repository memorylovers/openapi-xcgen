/**
 * security-scheme-transformer.ts - SecuritySchemeObjectをIRSecuritySchemeに変換
 *
 * 責務:
 * - 単一のSecuritySchemeObjectの変換
...
if (import.meta.vitest) {
  ...
  describe("transformSecurityScheme", () => {
    it("should convert API key security scheme", () => {
      ...
      const result = transformSecurityScheme(apiKeyScheme);
    ...
    it("should convert HTTP Bearer security scheme", () => {
      ...
      const result = transformSecurityScheme(bearerScheme);
    ...
    it("should convert OAuth2 with authorization code flow", () => {
      ...
      const result = transformSecurityScheme(oauth2Scheme);
    ...
    it("should convert OpenID Connect security scheme", () => {
      ...
      const result = transformSecurityScheme(openIdScheme);
    ...
    it("should handle $ref reference", () => {
      ...
      const result = transformSecurityScheme(refScheme);
    ...
    it("should handle unsupported type", () => {
      ...
      const result = transformSecurityScheme(invalidScheme);
